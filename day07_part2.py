...
def evaluate_expression(numbers: List[int], operators: List[str]) -> int:
    """Evaluate expression left-to-right with concatenation."""
    result = numbers[0]
            ...
            try:
                ...
                if result == test_value:
                    if debug:
                        ...
                        print(
                            f"Found valid equation: {test_value} = {op_str} = {result}"
                        )
...
if __name__ == "__main__":
    ...
    print(f"\nFinal answer: {result}")  # Should be 11387 for the example
